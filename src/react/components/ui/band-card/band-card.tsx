import { Image, Ripple, Typography } from 'juanmsl/ui';
    ...
    <BandCardStyle>
      ...
      <section className='band-data-content'>
        ...
        <Typography className='band-description' variant='label' noPadding>
          ...
          exercitationem illum iste laudantium maxime nulla officiis, repellendus sunt? A alias assumenda deleniti ipsum
          omnis recusandae, repellat saepe vero?
        </Typography>
      </section>
